...
df_raw = pl.read_csv("../data/ImpVinhos.csv", separator=";", truncate_ragged_lines=True)
df_raw.head()
...
# %% #################
# Grafico de Linha - Valor Importado (US$) no Ano por País
######################
fig = px.line(df_cleaned, x="year", y="value", color="country")
fig.show()

# %% #################
# Scatterplot - Valor Importado (US$) vs Litros Importados
######################
...
# %% #################
# Grafico de barra - Valor total Importado (US$) por Ano
######################
...
# %% #################
# Grafico de barra - Valor total Importado (US$) por Década
######################
df_aux = (
...
# %% #################
# Grafico de barra - Valor total Importado (US$) por Continente
#######################
...
# %% #################
# Mapa - Valor total Importado (US$) por Pais
#######################
...
fig.show()
# %% #################
# Mapa - Valor total Importado (US$) por Pais por ano
#######################
...
# %% #################
# Mapa 2 - Valor total Importado (US$) por Pais por ano
#######################
df_aux = df_cleaned.group_by(["continent", "iso_code"]).agg(pl.sum("value"))
fig = px.choropleth(
    df_aux,
...
fig.show()
# %% #################
# Scatterplot - Litros Importados vs Idade Média
######################
...
fig.show()
# %% #################
# Scatterplot - Litros Importados vs Sex Ratio
######################
...
# %% #################
# Scatterplot - Litros Importados vs Population Density
######################
...
# %% #################
# Scatterplot - Valor do Litro Importado vs Média de Idade
######################
...
# %% #################
# Scatterplot - Valor Médio do Litro Importado vs Média de Idade por Ano
######################
...
# %% #################
# Scatterplot - Valor Médio do Litro Importado vs Ano de Importação
######################
...
# O Valor médio do litro importado vem aumentando com o passar do tempo (correlação positiva entre ano e valor do litro)
