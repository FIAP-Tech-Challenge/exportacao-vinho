...
with tab3:
    st.markdown(
"<p style='text-align: justify; color:white; font-size:18px'>Para produzir vinhos brancos, as uvas são transportadas para dois cilindros responsáveis pela extração do suco. Durante essa extração as uvas liberam os taninos suaves que estão presentes nas cascas e sementes.</p>",  unsafe_allow_html=True
    )
    st.markdown(
...
st.markdown(
"<p style='text-align: justify; color:white; font-size:18px'>Deste gráfico, podemos tirar diversas conclusões, a mais clara e evidente é que os vinhos de mesa são os artigos mais produzidos pela Embrapa, seguidos dos derivados, sucos e por último os vinhos finos de mesa.</p>",  unsafe_allow_html=True
    )

st.markdown(
"<p style='text-align: justify; color:white; font-size:18px'>Analisando esse gráfico mais profundamente, é notório que no ano de 2016 houve uma queda considerável na produção de todas as categórias, precisamos extrair mais insights para ver o que ocorreu para ocasionar essa baixa.</p>",  unsafe_allow_html=True
    )
...
def tratar_dados_imet():
    ...
    for i in range(0,16):
        dados_imet_rs = pd.read_csv(f'data/INMET_S_RS_A801_PORTO ALEGRE_{2007+i}.csv', encoding='ISO-8859-1', sep=';',skiprows=8)
...
st.markdown(
"<p style='text-align: center; color:white; font-size:16px'>Precipitação Total (mm) por ano em Porto Alegre - RS</p>",  unsafe_allow_html=True
    )
...
st.markdown(
"<p style='text-align: center; color:white; font-size:16px'>Umidade média por ano em Porto Alegre - RS</p>",  unsafe_allow_html=True
    )
st.bar_chart(data=df_imet_tratado, x='Ano', y='Umidade_Media_%')

st.markdown(
"<p style='text-align: justify; color:white; font-size:18px'>Já no segundo gráfico de barras não foi possível tirar conclusões se a umidade média afetou de algum modo a produção.</p>",  unsafe_allow_html=True
    )
...
st.markdown(
"<p style='text-align: center; color:white; font-size:16px'>Produção em Milhões de Litros de vinhos de mesa</p>",  unsafe_allow_html=True
    )
