...
df = pl.read_csv("https://raw.githubusercontent.com/FIAP-Tech-Challenge/exportacao-vinho/df9394bbead195293a0fb02640a8e2fdb916e324/app/data/importacao.csv",truncate_ragged_lines=True)

st.set_page_config(page_title="Importação de Vinho", page_icon="🍷", layout="wide")

st.markdown("<p style='text-align: center; color:purple;font-size:54px'> Somos a empresa nº 1 do Brasil. </p>",  unsafe_allow_html=True)
